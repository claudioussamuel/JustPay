  ...
  return (
    <div className='h-[100vh]'>
      ...
      <div className='max-w-2xl flex items-center gap-5 mt-5 border p-2 bg-brand-gray rounded-full '>
        ...
        <Input
          type="text"
          className='w-full placeholder:text-[20px] placeholder:text-zinc-800 placeholder:font-dmMono text-zinc-800 outline-none border-none shadow-none placeholder:items-center bg-transparent font-dmMono'
